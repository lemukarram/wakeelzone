...
$pageTitle = 'Advocate & Lawyer in Islamabad';
$pageDesc  = 'Find verified advocates and lawyers in Islamabad for all legal matters — writ petitions, SECP, federal service law, corporate, family and more. 24/7 anonymous consultations.';
...
<div class="page-header">
  <div class="container page-header-inner">
    <h1 class="page-header-title heading-1">Advocate &amp; Lawyer in Islamabad</h1>
    <p class="page-header-sub">Verified Lawyers Available in Islamabad for All Legal Matters</p>
    <nav class="breadcrumb" aria-label="Breadcrumb">
      ...
      <span class="breadcrumb-sep"><i class="ph ph-caret-right"></i></span>
      <span class="breadcrumb-item">Islamabad</span>
    </nav>
  </div>
</div>
  ...
  <div class="container">
    <div class="why-us-grid">
      ...
      <div class="reveal-left">
        <span class="section-label"><i class="ph ph-map-pin"></i> Legal Services in Islamabad</span>
        <h2 class="heading-1">Top Verified Advocates in Islamabad</h2>
        <div class="divider-gold"></div>
        <p style="margin-top:1.25rem;font-size:var(--text-sm);color:var(--clr-text-3);line-height:var(--leading-relaxed);">
          Islamabad is Pakistan's federal capital, home to the Supreme Court of Pakistan, the Islamabad High Court, and numerous federal regulatory bodies including SECP, PEMRA, PTA, and NAB headquarters. Legal matters in the capital often have national implications — from government service disputes and federal writ petitions to corporate regulatory compliance and media law. WakeelZone's Islamabad panel brings you verified IHC-enrolled advocates and Supreme Court lawyers at your fingertips, anonymously.
        </p>
      ...
      <div class="reveal-right">
        <div style="background:linear-gradient(135deg,var(--clr-primary),var(--clr-primary-light));border-radius:var(--radius-xl);padding:2.5rem;color:var(--clr-text-inverse);position:relative;overflow:hidden;">
          ...
          <div style="position:relative;z-index:1;">
            <i class="ph ph-buildings" style="font-size:3rem;color:var(--clr-gold);margin-bottom:1rem;display:block;"></i>
            <h3 style="font-size:1.25rem;font-weight:800;margin-bottom:0.75rem;">Islamabad — Federal Capital</h3>
            <p style="color:rgba(255,255,255,0.75);line-height:var(--leading-relaxed);font-size:var(--text-sm);">
              Pakistan's capital city hosting the Supreme Court, Islamabad High Court (est. 2010), and federal regulators SECP, PEMRA, PTA, and NAB headquarters.
            </p>
          </div>
        </div>
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-top:1rem;">
          <div style="background:var(--clr-gold-50);border:1px solid rgba(201,168,76,0.2);border-radius:var(--radius-lg);padding:1.5rem;text-align:center;">
            ...
            <div style="font-size:var(--text-xs);color:var(--clr-text-muted);font-weight:600;text-transform:uppercase;letter-spacing:0.08em;margin-top:0.25rem;">Lawyers in Islamabad</div>
          </div>
...
<section class="section-sm bg-surface-2">
  <div class="container">
    <div class="section-header center reveal">
      ...
      <h2 class="heading-2">Courts &amp; Tribunals in Islamabad</h2>
    ...
    <div style="display:flex;flex-wrap:wrap;justify-content:center;gap:0.75rem;" class="reveal d-1">
      <?php
      $isb_courts = ['Islamabad High Court','Supreme Court of Pakistan','Federal Shariat Court','ATIR (Tax Tribunal)','SECP Tribunals','District &amp; Sessions Courts','Family Courts','Anti-Terrorism Court','PEMRA Tribunal','NAB Accountability Court'];
      foreach ($isb_courts as $court): ?>
...
<section class="section">
  <div class="container">
    <div class="section-header center reveal">
      ...
      <h2 class="heading-2">Legal Services Available in Islamabad</h2>
      <div class="divider-gold center"></div>
      <p style="margin-top:1rem;max-width:600px;margin-inline:auto;">Our Islamabad panel covers every area of law. Click a service to consult a specialist today.</p>
    </div>
...
<section class="section bg-surface-2">
  <div class="container">
    <div class="section-header center reveal">
      ...
      <h2 class="heading-2">Why Choose WakeelZone in Islamabad?</h2>
      <div class="divider-gold center"></div>
    </div>
    <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:1.25rem;max-width:900px;margin-inline:auto;">
      <?php
      $why = [
        ['icon'=>'ph-seal-check',    'title'=>'Verified PBC Advocates',        'desc'=>'All Islamabad lawyers are cross-verified with Pakistan Bar Council and Islamabad Bar Council records before joining our panel.'],
        ['icon'=>'ph-clock',         'title'=>'24/7 Availability',             'desc'=>'Federal matters often arise urgently. WakeelZone\'s Islamabad helpline is available around the clock every day of the year.'],
        ['icon'=>'ph-shield-lock',   'title'=>'Anonymous Consultation',        'desc'=>'Sensitive government service disputes and regulatory matters are handled with complete confidentiality and anonymity.'],
        ['icon'=>'ph-currency-circle-dollar','title'=>'Transparent Pricing',   'desc'=>'Clear, upfront rates with no hidden fees. Know your consultation cost before speaking to your Islamabad lawyer.'],
      ];
      foreach ($why as $i => $w): ?>
...
<section class="section">
  <div class="container" style="max-width:800px;">
    <div class="section-header center reveal">
      ...
      <h2 class="heading-2">Frequently Asked Questions — Islamabad</h2>
      <div class="divider-gold center"></div>
    </div>
    <?php
    $faqs_city = [
      ['q'=>'Can I challenge a federal government decision through WakeelZone in Islamabad?',
       'a'=>'Yes. Our Islamabad panel includes specialists in government service law, administrative law, and writ petitions before the Islamabad High Court. Whether you have a dismissal order, a regulatory dispute with SECP or PTA, or a NAB matter, we can match you with the right IHC advocate.'],
      ['q'=>'How do I find a SECP or corporate lawyer in Islamabad?',
       'a'=>'Call our helpline and specify that you need a corporate or SECP lawyer in Islamabad. We will match you instantly with advocates experienced in company registration, SECP compliance, shareholder disputes, and M&A transactions in the federal capital.'],
