...
$pageTitle = 'Advocate & Lawyer in Rawalpindi';
$pageDesc  = 'Find verified advocates and lawyers in Rawalpindi for all legal matters — property, criminal, family, corporate and more. 24/7 anonymous consultations available.';
...
<div class="page-header">
  <div class="container page-header-inner">
    <h1 class="page-header-title heading-1">Advocate &amp; Lawyer in Rawalpindi</h1>
    <p class="page-header-sub">Verified Lawyers Available in Rawalpindi for All Legal Matters</p>
    <nav class="breadcrumb" aria-label="Breadcrumb">
      ...
      <span class="breadcrumb-sep"><i class="ph ph-caret-right"></i></span>
      <span class="breadcrumb-item">Rawalpindi</span>
    </nav>
  </div>
</div>
  ...
  <div class="container">
    <div class="why-us-grid">
      ...
      <div class="reveal-left">
        <span class="section-label"><i class="ph ph-map-pin"></i> Legal Services in Rawalpindi</span>
        <h2 class="heading-1">Top Verified Advocates in Rawalpindi</h2>
        <div class="divider-gold"></div>
        <p style="margin-top:1.25rem;font-size:var(--text-sm);color:var(--clr-text-3);line-height:var(--leading-relaxed);">
          Rawalpindi — the twin city of Islamabad — is one of Pakistan's most strategically important cities, home to a busy Lahore High Court bench, active District and Sessions Courts, and one of the largest military cantonment areas in the country. Legal matters in Rawalpindi span property disputes in Bahria Town, criminal cases, family law, and defence-related civil matters. WakeelZone connects you with verified Rawalpindi advocates who know the local courts inside and out.
        </p>
      ...
      <div class="reveal-right">
        <div style="background:linear-gradient(135deg,var(--clr-primary),var(--clr-primary-light));border-radius:var(--radius-xl);padding:2.5rem;color:var(--clr-text-inverse);position:relative;overflow:hidden;">
          ...
          <div style="position:relative;z-index:1;">
            ...
            <h3 style="font-size:1.25rem;font-weight:800;margin-bottom:0.75rem;">Rawalpindi — Twin City</h3>
            <p style="color:rgba(255,255,255,0.75);line-height:var(--leading-relaxed);font-size:var(--text-sm);">
              Strategically located twin city to Islamabad. Home to the Lahore High Court Rawalpindi Bench, busy district courts, and one of Pakistan's largest cantonment zones.
            </p>
          </div>
        </div>
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-top:1rem;">
          <div style="background:var(--clr-gold-50);border:1px solid rgba(201,168,76,0.2);border-radius:var(--radius-lg);padding:1.5rem;text-align:center;">
            <div style="font-size:2rem;font-weight:800;color:var(--clr-primary);">350+</div>
            <div style="font-size:var(--text-xs);color:var(--clr-text-muted);font-weight:600;text-transform:uppercase;letter-spacing:0.08em;margin-top:0.25rem;">Lawyers in Rawalpindi</div>
          </div>
          <div style="background:var(--clr-primary-50);border:1px solid rgba(27,58,107,0.1);border-radius:var(--radius-lg);padding:1.5rem;text-align:center;">
            <div style="font-size:2rem;font-weight:800;color:var(--clr-primary);">1,400+</div>
...
<section class="section-sm bg-surface-2">
  <div class="container">
    <div class="section-header center reveal">
      ...
      <h2 class="heading-2">Courts &amp; Tribunals in Rawalpindi</h2>
    ...
    <div style="display:flex;flex-wrap:wrap;justify-content:center;gap:0.75rem;" class="reveal d-1">
      <?php
      $rwp_courts = ['LHC Rawalpindi Bench','District &amp; Sessions Courts','Anti-Terrorism Court','Family Courts','Labour Courts','Consumer Courts','Special Magistrate Courts','Cantonment Courts'];
      foreach ($rwp_courts as $court): ?>
...
<section class="section">
  <div class="container">
    <div class="section-header center reveal">
      ...
      <h2 class="heading-2">Legal Services Available in Rawalpindi</h2>
      <div class="divider-gold center"></div>
      <p style="margin-top:1rem;max-width:600px;margin-inline:auto;">Our Rawalpindi panel covers every area of law. Click a service to consult a specialist today.</p>
    </div>
...
<section class="section bg-surface-2">
  <div class="container">
    <div class="section-header center reveal">
      ...
      <h2 class="heading-2">Why Choose WakeelZone in Rawalpindi?</h2>
      <div class="divider-gold center"></div>
    </div>
    <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:1.25rem;max-width:900px;margin-inline:auto;">
      <?php
      $why = [
        ['icon'=>'ph-seal-check',    'title'=>'Verified PBC Advocates',        'desc'=>'Every Rawalpindi lawyer on our platform is verified against Pakistan Bar Council and Punjab Bar Council enrollment databases.'],
        ['icon'=>'ph-clock',         'title'=>'24/7 Availability',             'desc'=>'Legal issues don\'t follow business hours. Our Rawalpindi helpline operates 24 hours a day, seven days a week.'],
        ['icon'=>'ph-shield-lock',   'title'=>'Anonymous Consultation',        'desc'=>'Discuss property fraud, criminal matters, or family disputes with Rawalpindi advocates — completely anonymously.'],
        ['icon'=>'ph-currency-circle-dollar','title'=>'Transparent Pricing',   'desc'=>'Competitive rates with complete transparency. No surprises — know your consultation fee before you begin.'],
      ];
      foreach ($why as $i => $w): ?>
...
<section class="section">
  <div class="container" style="max-width:800px;">
    <div class="section-header center reveal">
      ...
      <h2 class="heading-2">Frequently Asked Questions — Rawalpindi</h2>
      <div class="divider-gold center"></div>
    </div>
    <?php
    $faqs_city = [
      ['q'=>'Can I get help with a Bahria Town property dispute in Rawalpindi?',
       'a'=>'Yes. Our Rawalpindi panel includes property lawyers experienced in Bahria Town, DHA Rawalpindi, and Saddar area disputes. We handle title verification, builder disputes, and land record correction cases regularly.'],
      ['q'=>'How do I find a criminal lawyer in Rawalpindi for bail or FIR matters?',
       'a'=>'Call our helpline and describe your criminal matter. We will immediately match you with a verified Rawalpindi criminal advocate experienced in bail applications, FIR registration, and anti-terrorism court proceedings.'],
